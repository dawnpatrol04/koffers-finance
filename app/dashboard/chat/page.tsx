  ...
  return (
    <div className="flex h-full overflow-hidden -m-4 md:-m-8">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="flex-shrink-0 border-t border-border bg-background px-4 pt-3 pb-1 md:px-6 md:pb-2">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xs text-muted-foreground mt-0.5 mb-0 text-center">
